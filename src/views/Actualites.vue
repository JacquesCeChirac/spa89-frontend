    ...
    <v-container>
        ...
        >
            <v-flex mb-4>
                ...
                <p>-	La SPA, souvent improprement dite «nationale», avec ses 55 refuges, qui est une organisation ayant son siège et ses locaux à Paris, celle-là même qui,
                    régulièrement, et encore en 2017, est épinglée par la Cour de Comptes et dont les conflits internes alimentent les gazettes.
                </p>
                <p>La SPA, pourtant totalement absente de certaines régions, a entamé une vaste campagne destinée à proposer aux passants,
                    dans les villes où elle n’a pourtant absolument aucune activité de protection animale, de devenir des donateurs réguliers via un prélèvement d’argent automatique…
                    C’est aujourd’hui le cas dans les rues de Strasbourg (Bas-Rhin).
                </p>
                <p>Fausses apparences et illusions sont les deux ferments de la tromperie qui scandalise aujourd’hui à juste titre de nombreux amis des animaux, mais aussi des élus,
                    parfois persuadés que la SPA sise à Paris répartit équitablement les dons qu’elle perçoit à l’ensemble des refuges de France. C’est pourtant totalement faux…
                </p>
                <p>Gare donc aux discours et autres éléments de langage parfaitement rodés qui vous seront présentés dans les rues,
                    mais oublieront de préciser que votre générosité ne servira qu’aux intérêts d’une toute petite partie des animaux abandonnés.
                </p>
                <p>Notre refuge, adhérent de la Confédération Nationale Défense de l’Animal, est indépendant : aidez-le en direct pour sauver les animaux de votre région.
                ...
                <ul>
                    ...
                    <li>Pour effectuer des pré-visites avant adoptions,</li>
                    <li>Pour assister les enquêteurs sur la maltraitance,</li>
